        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherVerificationKey = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetSemester = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Departments_TargetDeptId",
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "Name", "TeacherVerificationKey" },
                values: new object[,]
                {
                    { 1, "CSE", "CSE-KEY" },
                    { 2, "EEE", "EEE-KEY" },
